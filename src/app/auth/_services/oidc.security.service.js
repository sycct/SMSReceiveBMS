...
var OidcSecurityService = (function () {
    ...
    OidcSecurityService.prototype.authorizedCallbackWithCode = function (urlToCheck) {
    ...
    OidcSecurityService.prototype.requestTokensWithCode = function (code, state, session_state) {
        var _this = this;
        this._isModuleSetup
    ...
    OidcSecurityService.prototype.requestTokensWithCodeProcedure = function (code, state, session_state) {
        var _this = this;
        var tokenRequestUrl = '';
    ...
    OidcSecurityService.prototype.authorizedCodeFlowCallbackProcedure = function (result) {
    ...
    OidcSecurityService.prototype.authorizedCallbackProcedure = function (result, isRenewProcess) {
        var _this = this;
    ...
    OidcSecurityService.prototype.createAuthorizeUrl = function (isCodeFlow, code_challenge, redirect_url, nonce, state, authorization_endpoint, prompt) {
